...
###############################################################
# illustration for target and observed responses in section 1.2
###############################################################
...
plt.plot(t, target, linewidth=2, color='blue', linestyle='-', label="Target")
plt.plot(t, obs_data_mean, linewidth=2, color='red', linestyle='-', label="Pointwise Mean")
